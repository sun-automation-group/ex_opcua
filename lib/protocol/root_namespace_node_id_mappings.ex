defmodule ExOpcua.Protocol.RootNamespaceNodeIDMappings do
  ...
  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_SERVERVIEWCOUNT,
    do: quote(do: 2276)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_CURRENTSESSIONCOUNT,
    do: quote(do: 2277)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_CUMULATEDSESSIONCOUNT,
    do: quote(do: 2278)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_SECURITYREJECTEDSESSIONCOUNT,
    do: quote(do: 2279)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_SESSIONTIMEOUTCOUNT,
    do: quote(do: 2281)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_SESSIONABORTCOUNT,
    do: quote(do: 2282)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_PUBLISHINGINTERVALCOUNT,
    do: quote(do: 2284)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_CURRENTSUBSCRIPTIONCOUNT,
    do: quote(do: 2285)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_CUMULATEDSUBSCRIPTIONCOUNT,
    do: quote(do: 2286)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_SECURITYREJECTEDREQUESTSCOUNT,
    do: quote(do: 2287)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_REJECTEDREQUESTSCOUNT,
    do: quote(do: 2288)
  ...
  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SERVERDIAGNOSTICSSUMMARY_REJECTEDSESSIONCOUNT,
    do: quote(do: 3705)

  # Object
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SESSIONSDIAGNOSTICSSUMMARY, do: quote(do: 3706)
  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SESSIONSDIAGNOSTICSSUMMARY_SESSIONDIAGNOSTICSARRAY,
    do: quote(do: 3707)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERDIAGNOSTICS_SESSIONSDIAGNOSTICSSUMMARY_SESSIONSECURITYDIAGNOSTICSARRAY,
    do: quote(do: 3708)
  ...
  # Variable
  defmacro ua_ns0id_HACONFIGURATION_AGGREGATECONFIGURATION_TREATUNCERTAINASBAD,
    do: quote(do: 11204)
  ...
  # Variable
  defmacro ua_ns0id_HACONFIGURATION_AGGREGATECONFIGURATION_USESLOPEDEXTRAPOLATION,
    do: quote(do: 11207)
  ...
  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERREAD,
    do: quote(do: 11705)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERWRITE,
    do: quote(do: 11707)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERMETHODCALL,
    do: quote(do: 11709)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERBROWSE,
    do: quote(do: 11710)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERREGISTERNODES,
    do: quote(do: 11711)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERTRANSLATEBROWSEPATHSTONODEIDS,
    do: quote(do: 11712)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERNODEMANAGEMENT,
    do: quote(do: 11713)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXMONITOREDITEMSPERCALL,
    do: quote(do: 11714)
  ...
  # Variable
  defmacro ua_ns0id_SERVER_NAMESPACES_ADDRESSSPACEFILE_GETPOSITION_INPUTARGUMENTS,
    do: quote(do: 11732)

  # Variable
  defmacro ua_ns0id_SERVER_NAMESPACES_ADDRESSSPACEFILE_GETPOSITION_OUTPUTARGUMENTS,
    do: quote(do: 11733)

  # Method
  defmacro ua_ns0id_SERVER_NAMESPACES_ADDRESSSPACEFILE_SETPOSITION, do: quote(do: 11734)
  # Variable
  defmacro ua_ns0id_SERVER_NAMESPACES_ADDRESSSPACEFILE_SETPOSITION_INPUTARGUMENTS,
    do: quote(do: 11735)
  ...
  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERHISTORYREADDATA,
    do: quote(do: 12165)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERHISTORYREADEVENTS,
    do: quote(do: 12166)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERHISTORYUPDATEDATA,
    do: quote(do: 12167)

  # Variable
  defmacro ua_ns0id_SERVER_SERVERCAPABILITIES_OPERATIONLIMITS_MAXNODESPERHISTORYUPDATEEVENTS,
    do: quote(do: 12168)
